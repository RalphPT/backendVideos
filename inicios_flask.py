...
# Indicar si nuestro archivo es el archivo principal, si el archivo es el principal su valor será '__name__'
app = Flask(__name__)
...
@app.route('/')
def inicio():
    # Modificar el comportamiento del método de la clase Flask para evitar modificar el método en la misma clase
    print('hola')
